...
#check the range in your sample.
#summary(earnings_df$age_recode)
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
#  21.00   32.00   44.00   43.26   54.25   65.00      20 
...
#use mutate function to create a new variable age_sq in the earnings_df data frame
...
#Model 1: earn ~ age_recode + edu + female + black + other + edu * female
#Model 2: earn ~ age_recode + edu + female + black + other + edu * female + 
#    age_sq
#  Res.Df   RSS Df Sum of Sq    F Pr(>F)
#1    973 60403                         
#2    972 60396  1    6.8367 0.11 0.7402

#Result of ANOVA:we cannot reject H0. There
